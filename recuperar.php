...
$correo_fijo = 'mateobarrera645@gmail.com';  // Cambia este correo por el que deseas usar
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows == 1) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'mateobarrera645@gmail.com';
            $mail->Password = 'ndwy flde kkdk ndvq'; 
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
            $mail->Port = 587;

            // Receptor del correo (correo fijo)
            $mail->setFrom('mateobarrera645@gmail.com', 'Recuperación de Contraseña');
