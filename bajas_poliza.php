...
?>
    ...
    <script>
        $(document).ready(function () {
            // Función para manejar el cambio de tablas
            ...
            // Mostrar tabla por defecto (Tabla X)
            $('#tablaX').show(); // Mostrar Tabla X por defecto
            $('#tablaY').hide(); // Ocultar Tabla Y por defecto
        });
    </script>
</body>
